...
def load_documents() -> List:
    ...
    products = [
        Product('red_hat_openshift_ai_self-managed', 'Red Hat OpenShift AI Self-Managed', '2.10', 'en-US'),
        Product('red_hat_openshift_ai_self-managed', 'Red Hat OpenShift AI Self-Managed', '2.9', 'en-US'),
        Product('red_hat_openshift_ai_self-managed', 'Red Hat OpenShift AI Self-Managed', '2.8', 'en-US'),
        Product('openshift_container_platform', 'Red Hat OpenShift Container Platform', '4.15', 'en-US'),
        Product('openshift_container_platform', 'Red Hat OpenShift Container Platform', '4.14', 'en-US'),
        Product('openshift_container_platform', 'Red Hat OpenShift Container Platform', '4.13', 'en-US'),
        Product('openshift_container_platform', 'Red Hat OpenShift Container Platform', '4.12', 'en-US')
    ]
    return products
